...
<html lang="en" style="background: #AAAAAA;">
    ...
    <body style="background: #AAAAAA;">
        <div class="container" id="tableDiv" style="text-align: center;">
            ...
            <h1 style="text-align: center;">Welcome back to your Teacher profile page <?=$_SESSION['username']?></h1>

            <ul class="nav nav-pills nav-fill">
                <li class="nav-item">
                    <a class="nav-link active" href="<?=BASE?>/Teacher/teacherProfilePage/">Profile Page</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?=BASE?>/Teacher/courses/">Your Classes</a>
                </li>
                <li class="nav-item">
            ...
            <h3>Last Name - <?=$_SESSION['last_name']?></h3>
                ...
                <a href="<?=BASE?>/Teacher/editInformation" style='color: white;'>Modify Profile Information</a>
            </button></br>
        </div>
	</body>
</html>