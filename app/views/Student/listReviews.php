        ...
        <body style="background: #AAAAAA;">
            <div class="container" id="tableDiv" style="text-align: center;">
                    ...
                    foreach($data as $review){
                        ...
                        echo "<div class='card text-center'>
                            ...
                            if($review->user_id == $_SESSION["user_id"]){
                                echo "
                                <a href='".BASE."/Review/modifyReview/$review->class_id/$review->review_id'>Modify your Review</a></br>
                                <a href='".BASE."/Review/deleteReview/$review->class_id/$review->review_id'>Delete your Review</a></br>
                                ";
                            }
                ...
                ?>
                    ...
                    <a href='<?=BASE?>/Review/leaveReview/<?=$_SESSION["class_id"]?>' style="color: white;">Leave a Review</a></br>
                </button>
                
                </br></br><p><a class="nav-link" href="<?=BASE?>/Student/backSearchResults/">Cancel</a></p>
